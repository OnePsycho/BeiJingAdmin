	...
	<div class="table">
		...
		<div class="container">
			<div class="handle-box">
				<el-select v-model="select_cate" placeholder="分类" class="handle-select mr10" @change="selectChange">
					<el-option key="1" label="方案" value="3"></el-option>
					<el-option key="2" label="施工图" value="2"></el-option>
			...
			<el-table :data="data" border class="table" v-loading="loading" ref="multipleTable" stripe @selection-change="handleSelectionChange">
				...
				<el-table-column prop="id" label="分类名称"  align="center" width="80">
				</el-table-column>
				<el-table-column prop="username" label="分类"  align="center">
				</el-table-column>
				<el-table-column prop="phoneNum" label="默认展开"  align="center">
				</el-table-column>
				<el-table-column prop="email" label="创建时间"  sortable align="center">
				</el-table-column>
