	...
	<div class="table">
		...
		<div class="container">
			<div class="handle-box">
				<el-select v-model="select_cate" placeholder="状态" class="handle-select mr10" @change="selectChange">
					<el-option key="1" label="正常" value="3"></el-option>
		...
		<el-dialog title="修改状态" :visible.sync="modifyVisible" width="620px">
			<el-form ref="form" :model="form" label-width="100px" :disabled="true">
				<el-form-item label="管理员姓名" prop="product_category_name">
					<el-label v-model="form.product_category_name"></el-label>
				</el-form-item>
				<el-form-item label="登录名" prop="product_category_name">
					<el-label v-model="form.product_category_name"></el-label>
				</el-form-item>
		...
		<el-dialog title="新增管理员" :visible.sync="addVisible" width="620px">
			<el-form ref="form" :model="form" label-width="100px">
				<el-form-item label="管理员姓名" prop="product_name">
					<el-input v-model="form.product_name" placeholder="请输入管理员姓名"></el-input>
				</el-form-item>
				<el-form-item label="登录名" prop="product_name">
					<el-input v-model="form.product_name" placeholder="请输入登录名"></el-input>
				</el-form-item>
				<el-form-item label="密码" prop="product_name">
					<el-input v-model="form.product_name" placeholder="请输入密码"></el-input>
				</el-form-item>
				<el-form-item label="状态" prop="product_category_name">
					<el-select v-model="form.product_category_name">
					<el-option key="1" label="正常" value="3"></el-option>
					<el-option key="2" label="待审核" value="2"></el-option>
					<el-option key="3" label="审核未通过" value="1"></el-option>
					</el-select>
	...
	export default {
		...
		methods: {
			...
			getData() {
				this.select_cate="";
				this.select_word="";
				this.url = this.apiUrl+'/client/api/admin/findPage';
				this.$axios.get(this.url).then((res) => {
					console.log(res);
